...
<div class="bd-contentlayout-6 bd-page-width   bd-sheetstyles " >
 ...
 <?php renderTemplateFromIncludes('sidebar_area_4'); ?>
		...
		<div class="bd-containereffect-7 container "><div class=" bd-layoutbox-16  clearfix">
    <div class="bd-container-inner">
 ...
 col-md-3
 col-sm-4">
    <div class="bd-layoutcolumn-68 bd-column" ><div class="bd-vertical-align-wrapper"><form id="search-12" role="form" class=" bd-search-12 form-inline" name="search" <?php echo funcBuildRoute(JFactory::getDocument()->baseurl . '/index.php', 'action'); ?> method="post">
    <div class="bd-container-inner">
        ...
        <div class="bd-search-wrapper">
                ...
                <div class="bd-button-wrapper">
                    <input type="submit" class=" bd-button-22" value="<?php echo JText::_('TPL_SEARCH_BUTTON_VALUE'); ?>" link-disable="true">
                </div>
        </div>
        <script>
            (function (jQuery, $) {
                jQuery('.bd-search-12 .bd-icon-53').on('click', function (e) {
                    e.preventDefault();
