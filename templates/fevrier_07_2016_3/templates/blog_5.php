...
<div class="bd-contentlayout-5 bd-page-width   bd-sheetstyles " >
    <div class="bd-container-inner">
 ...
 <?php renderTemplateFromIncludes('sidebar_area_4'); ?>
		...
		<div class="bd-containereffect-6 container "><div class=" bd-layoutbox-15  clearfix">
    <div class="bd-container-inner">
 ...
 col-md-9
 col-sm-8">
    <div class="bd-layoutcolumn-60 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-socialicons-5">
    
        <a target="_blank" class=" bd-socialicon-21 bd-socialicon" href="//www.facebook.com/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2Flogin.php%3Fskip_api_login%3D1%26api_key%3D966242223397117%26signed_next%3D1%26next%3Dhttps%253A%252F%252Fwww.facebook.com%252Fv2.3%252Fdialog%252Fshare%253Fredirect_uri%253Dhttps%25253A%25252F%25252Fwww.facebook.com%25252Fdialog%25252Freturn%25252Fclose%2526display%253Dpopup%2526href%253Dhttps%25253A%25252F%25252Ffr-fr.facebook.com%25252Flogin%25252F%2526client_id%253D966242223397117%2526ret%253Dlogin%26cancel_url%3Dhttps%253A%252F%252Fwww.facebook.com%252Fdialog%252Freturn%252Fclose%253F%2523_%253D_%26display%3Dpopup">
    <span class="bd-icon"></span><span></span>
</a>
    
        <a target="_blank" class=" bd-socialicon-22 bd-socialicon" href="//twitter.com/share?url=&amp;text=">
    <span class="bd-icon"></span><span></span>
</a>
    
        <a target="_blank" class=" bd-socialicon-23 bd-socialicon" href="//plus.google.com/share?url=">
    <span class="bd-icon"></span><span></span>
</a>
 ...
 col-md-3
 col-sm-4">
    <div class="bd-layoutcolumn-40 bd-column" ><div class="bd-vertical-align-wrapper"><form id="search-10" role="form" class=" bd-search-10 form-inline" name="search" <?php echo funcBuildRoute(JFactory::getDocument()->baseurl . '/index.php', 'action'); ?> method="post">
    <div class="bd-container-inner">
        ...
        <div class="bd-search-wrapper">
                ...
                <div class="bd-input-wrapper">
                    <input type="text" name="searchword" class=" bd-bootstrapinput-15 form-control" placeholder="Search">
                </div>
                
                <div class="bd-button-wrapper">
                    <input type="submit" class=" bd-button-21" value="<?php echo JText::_('TPL_SEARCH_BUTTON_VALUE'); ?>" link-disable="true">
                </div>
        </div>
        <script>
            (function (jQuery, $) {
                jQuery('.bd-search-10 .bd-icon-52').on('click', function (e) {
                    e.preventDefault();
